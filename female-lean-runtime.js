(async()=>{
  ...
  const source=await fetch('female-lean-base.html?standalone=20260818-fv2',{cache:'no-store'}).then(r=>{if(!r.ok)throw new Error('LP source unavailable');return r.text()});
