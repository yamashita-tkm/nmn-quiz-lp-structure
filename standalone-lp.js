(async()=>{
  ...
  continuity.textContent=`
    ...
    .standalone-shell .male-survey-pack{position:absolute;z-index:2;left:50%;top:310px;width:40%;height:auto;min-height:0;object-fit:contain;transform:translateX(-50%);filter:drop-shadow(0 15px 17px rgba(36,114,132,.19))}
